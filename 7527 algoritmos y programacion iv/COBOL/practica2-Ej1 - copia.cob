    ...
    º     05 WS-CANTIDAD-PAGOS PIC 9(2).
      ...
      *     DISPLAY WS-LINEA-BL
      *     DISPLAY WS-FINAL-LINEA
      *     DISPLAY WS-FINAL-ARCH
           CLOSE pagosFile.
      ...
      *        DISPLAY WS-ENCABEZADO1
      *        DISPLAY WS-ENCABEZADO2
      *        DISPLAY WS-LINEA-BL
      *        DISPLAY WS-NOMBRES-COLUMNAS
           ELSE
               CONTINUE.
      ...
      *        DISPLAY WS-NOMBRES-COLUMNAS
       ...
       ESCRIBIR_ENCABEZADO.
           WRITE REGISTRO-FILE FROM WS-ENCABEZADO1
